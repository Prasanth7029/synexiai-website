...
export default function TeamMemberCard({
 ...
 className="inline-block px-3 py-1 text-xs font-medium rounded-full text-cyan-400"
 >
 {skill}
 </MotionSpan>
 ))}
 ...
 whileTap={{ scale: 0.94 }}
 className="text-xl p-2 rounded-full hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
