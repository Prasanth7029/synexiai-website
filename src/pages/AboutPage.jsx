  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="rounded-3xl p-4 sm:p-8 md:p-12 border border-[var(--border-color)] bg-[var(--card-bg)]/60 shadow-2xl shadow-cyan-500/10">
            <MotionH2
              id="purpose-title"
            ...
            >
              ...
              {/* 2 on phones → 3 on md → 5 on lg */}
              <div className="grid-2-3 lg:grid-cols-5 auto-rows-fr gap-3 sm:gap-4 md:gap-6">
                {implementationProcess.map((step, index) => (
                  <div key={step.title} className="min-w-0">
                    <MotionDiv
                      ...
                      className="rounded-2xl p-3 sm:p-4 md:p-6 h-full flex flex-col
                                 border border-[var(--border-color)] bg-[var(--card-bg)]/60 hover:border-cyan-400/30
                    ...
                    >
                      ...
                      <h4 className="font-bold text-center mb-2 min-w-0 text-[clamp(13px,3.6vw,16px)] md:text-[18px]">
                        {step.title}
                      </h4>
                      <p className="text-[clamp(12px,3.4vw,14px)] text-gray-700 dark:text-gray-300 text-center leading-snug">
                        {step.description}
                      </p>
                    </MotionDiv>
                  </div>
        ...
        >
          ...
          <div className="grid-2-3 lg:grid-cols-4 auto-rows-fr gap-3 sm:gap-4 md:gap-6">
        ...
        >
          <div className="rounded-3xl p-4 sm:p-8 md:p-12 shadow-2xl shadow-cyan-500/10">
            ...
            <MotionDiv
              className="grid-2-3 lg:grid-cols-4 auto-rows-fr gap-3 sm:gap-4 md:gap-6"
              initial={prefersReduced ? false : { opacity: 0 }}
              whileInView={prefersReduced ? {} : { opacity: 1 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
            >
              {teamMembers.map((member, index) => (
                <div key={member.name ?? index} className="min-w-0">
                  <TeamMemberCard {...member} delay={index * 0.1} />
                </div>
              ))}
            </MotionDiv>
          </div>
        ...
        >
          <div className="max-w-4xl mx-auto rounded-3xl p-8 border border-[var(--border-color)] bg-[var(--card-bg)]/60 shadow-xl shadow-cyan-500/10">
            <MotionH2
              id="cta-title"
              initial={prefersReduced ? false : { opacity: 0, y: 20 }}
              whileInView={prefersReduced ? {} : { opacity: 1, y: 0 }}
            ...
            >
              ...
              {/* If /solutions isn't a real route yet, change this to /portfolio */}
