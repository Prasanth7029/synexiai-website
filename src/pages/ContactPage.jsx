  ...
  return (
    <div className="min-h-screen relative overflow-hidden py-16 px-4 sm:px-6 transition-all duration-500">
      ...
      <div className="max-w-2xl mx-auto relative z-10 text-gray-900 dark:text-gray-100">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Name */}
                <div>
                  <label className="block text-sm mb-2 text-gray-700 dark:text-gray-300" htmlFor="name">
                    Full Name
                  </label>
                  <input
                    id="name"
                ...
                {/* Email */}
                <div>
                  <label className="block text-sm mb-2 text-gray-700 dark:text-gray-300" htmlFor="email">
                    Email Address
                  </label>
                  <input
                    id="email"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {/* Subject */}
                <div>
                  <label className="block text-sm mb-2 text-gray-700 dark:text-gray-300" htmlFor="subject">
                    Subject
                  </label>
                  <input
                    id="subject"
                ...
                {/* Inquiry Type */}
                <div>
                  <label className="block text-sm mb-2 text-gray-700 dark:text-gray-300" htmlFor="inquiryType">
                    Inquiry Type
                  </label>
                  <select
                    id="inquiryType"
              ...
              {/* Message */}
              <div>
                <label className="block text-sm mb-2 text-gray-700 dark:text-gray-300" htmlFor="message">
                  Your Vision
                </label>
                <textarea
                  id="message"
        ...
        >
          <h3 className="text-xl font-bold mb-4 text-cyan-500">Other Ways to Connect</h3>
