...
/**
 * ContactPage — polished layout
 * - 80% centered width (max 1200px)
 * - Left info rail is sticky on desktop; form is fluid
 * - Even, aligned fields (h-12), consistent gaps
 * - Keeps your Formspree submit, validation, toast, and particles
 */
...
export default function ContactPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // TIP: move id to env if you prefer: import.meta.env.VITE_FORMSPREE_ID
      ...
      <AnimatePresence>
        {showToast && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -20 }}
            className={`fixed top-6 left-1/2 -translate-x-1/2 w-full max-w-xs px-6 py-3 rounded-xl shadow-lg z-[60] flex items-center justify-between space-x-3 focus:outline-none ${
              status === "success"
      ...
      <div className="relative z-10 mx-auto w-11/12 lg:w-4/5 max-w-[1200px]">
        ...
        <div className="grid grid-cols-1 lg:[grid-template-columns:320px_1fr] gap-6 md:gap-8">
          ...
          <div className="space-y-6 lg:sticky lg:top-24 self-start">
            <div className="rounded-xl p-6 border border-white/10 bg-white/5 shadow-lg h-full">
          ...
          <motion.form
            ...
            initial={{ opacity: 0, y: 12 }}
            animate={{ opacity: 1, y: 0 }}
            className="rounded-2xl p-4 sm:p-8 border border-white/10 bg-white/5 shadow-xl shadow-cyan-500/10"
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  required
                  className={`w-full px-4 h-12 rounded-lg bg-white/5 text-gray-900 dark:text-white border ${
              ...
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 h-12 rounded-lg bg-white/5 text-gray-900 dark:text-white border border-white/10 focus:outline-none focus:ring-2 focus:ring-cyan-500"
            ...
            <motion.button
              ...
              className={`mt-6 w-full h-12 rounded-lg font-bold flex items-center justify-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 ${
                isSubmitting
        ...
        <motion.div
          ...
          className="text-center py-8 border-t border-white/10 mt-10"
        >
