...
export default function ContactPage() {
 ...
 <div className="rounded-xl p-6 border border-white/10 bg-white/5 shadow-lg">
 ...
 className="rounded-xl p-4 sm:p-8 border border-white/10 bg-white/5 shadow-xl shadow-cyan-500/10 space-y-6"
 >
