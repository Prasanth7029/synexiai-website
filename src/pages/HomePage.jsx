...
const features = [
  {
    ...
    description: "Cutting-edge React + Vite website architecture with optimized performance",
    delay: 0.1
  },
  {
  ...
  return (
    <Layout>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-12 md:py-24 text-black dark:text-white">
        ...
        <section className="mb-24">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              Cutting-edge solutions designed for scalability, performance, and innovation
            </p>
          </motion.div>
        ...
        {/* Mission Statement */}
        <section className="py-16 px-8 bg-gradient-to-br from-gray-900 to-cyan-900/30 rounded-3xl border border-cyan-500/20 shadow-xl shadow-cyan-500/10 mb-24">
          <motion.div
        ...
        <section className="text-center">
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-block px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white rounded-xl text-lg font-semibold shadow-lg shadow-cyan-500/20 transition-all duration-300"
            >
              Get Started Today
            </motion.a>
          </motion.div>
