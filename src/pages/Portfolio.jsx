...
const StatCard = ({ icon, label, value }) => (
 <MotionDiv
 whileHover={{ y: -3 }}
 className="rounded-lg border border-white/10 bg-white/5 p-4 shadow-lg"
 >
...
const ProjectCard = ({ repo, index }) => (
 ...
 whileHover={{ y: -5 }}
 className="rounded-xl p-6 border border-white/10 bg-white/5 shadow-lg hover:shadow-cyan-500/20 transition-all h-full"
 >
 <div className="flex justify-between items-start mb-4 gap-4 min-w-0">
 <h3 className="text-xl font-semibold text-cyan-400 min-w-0">
 <a
 href={repo.html_url}
 target="_blank"
...
const VisionCard = ({ title, description, icon, color }) => (
 <MotionDiv
 whileHover={{ y: -5 }}
 className="p-4 sm:p-6 md:p-8 rounded-xl border border-white/10 bg-white/5 shadow-lg h-full flex flex-col"
 >
...
const RoadmapPhase = ({ phase, title, focus, timeline, icon, color }) => (
 ...
 className="relative pl-10 sm:pl-8 py-4 border-l-2 border-cyan-500/30"
 >
 <div
 className={`absolute left-[-12px] sm:left-[-15px] top-3 sm:top-4 w-6 h-6 sm:w-8 sm:h-8 rounded-full flex items-center justify-center ${color} text-white`}
 aria-hidden="true"
 >
 {icon}
 </div>
...
const PartnerLogo = ({ name, logo }) => (
 ...
 className="flex flex-col items-center justify-center rounded-xl border border-white/10 bg-white/5 p-4 shadow-lg h-full"
 >
...
export default function Portfolio() {
 ...
 <div className="text-cyan-500 text-lg sm:text-xl">
 Building the future...
 </div>
 </div>
 </div>
 ...
 <a
 href="#vision"
 className="bg-cyan-600 hover:bg-cyan-700 text-white px-6 py-3 rounded-lg font-medium transition-all text-center focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
 ...
 target="_blank"
 rel="noopener noreferrer"
 className="bg-transparent border border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 px-6 py-3 rounded-lg font-medium transition-all text-center focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
 ...
 className="mb-20 scroll-mt-[calc(var(--header-h,64px)+16px)]"
 >
 <div className="text-center mb-12">
 <h2 className="text-[clamp(1.5rem,3.5vw,2.25rem)] font-bold mb-4">
 ...
 <div className="md:w-1/2 rounded-xl p-8 border border-white/10 bg-white/5 shadow-lg">
 ...
 <div className="rounded-xl p-8 border border-white/10 bg-white/5 shadow-lg h-full">
 ...
 <Link
 to="/contact"
 className="bg-cyan-600 hover:bg-cyan-700 text-white px-8 py-4 rounded-lg font-medium text-lg transition-all text-center focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
 >
 Partner With Us
 </Link>
 <a
 href="/assets/synexisai-vision.pdf"
 className="bg-transparent border-2 border-cyan-500 text-cyan-400 hover:bg-cyan-500/10 px-8 py-4 rounded-lg font-medium text-lg transition-all text-center focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400"
 >
