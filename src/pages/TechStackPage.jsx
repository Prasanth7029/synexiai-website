...
const ArchitectureDiagram = () => (
  <div className="rounded-2xl p-4 sm:p-6 mb-16 border border-cyan-500/20 bg-white/5 backdrop-blur-md shadow-lg">
    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-8">
      {/* User Layer */}
      <div className="md:col-span-12 rounded-xl p-4 sm:p-6 border border-cyan-500/20 bg-gray-900/40">
      ...
      {/* AI Layer */}
      <div className="md:col-span-4 rounded-xl p-4 sm:p-6 border border-green-500/20 bg-gray-900/40">
        <div className="flex items-center justify-center mb-2">
      ...
      {/* Security Layer */}
      <div className="md:col-span-4 rounded-xl p-4 sm:p-6 border border-purple-500/20 bg-gray-900/40">
        <div className="flex items-center justify-center mb-2">
      ...
      {/* Energy Layer */}
      <div className="md:col-span-4 rounded-xl p-4 sm:p-6 border border-yellow-500/20 bg-gray-900/40">
        <div className="flex items-center justify-center mb-2">
      ...
      {/* Database Layer */}
      <div className="md:col-span-12 rounded-xl p-4 sm:p-6 border border-blue-500/20 bg-gray-900/40">
        <div className="flex items-center justify-center mb-2">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="rounded-2xl p-4 sm:p-6 mb-16 border border-cyan-500/20 bg-white/5 backdrop-blur-md shadow-lg">
            <div
              ...
              className="flex flex-wrap overflow-x-auto border-b border-cyan-500/20 mb-8"
            >
