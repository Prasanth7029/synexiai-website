        ...
        <ul className="space-y-4">
          {milestone.goals.map((goal, idx) => (
            <motion.li
              ...
              className={`flex items-start ${statusColors[goal.status] || "text-gray-300"}`}
            >
              <span className="mr-3 mt-1" aria-hidden="true">
          ...
          <section className="grid md:grid-cols-2 gap-8 mb-24">
            ...
            >
              ...
              <Link
                ...
                bg-cyan-600 hover:bg-cyan-500 text-white transition-all group"
              >
            ...
            >
              ...
              <a
                ...
                download
                className="inline-flex items-center px-6 py-3 rounded-lg font-semibold 
                bg-teal-600 hover:bg-teal-500 text-white transition-all group"
              >
