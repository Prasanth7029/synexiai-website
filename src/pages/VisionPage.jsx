  ...
  return (
    <Layout>
      <Container animate className="text-white">
        ...
        {/* Horizontal Project Timeline Bar */}
        ...
        >
          <h3 className="text-2xl text-cyan-400 font-semibold mb-4">🚀 Join Our Journey</h3>
        ...
        <section className="mt-24 text-center bg-gray-900/40 rounded-2xl px-6 py-10 border border-cyan-400/20">
          <h3 className="text-2xl font-semibold text-cyan-400 mb-4">🎯 Investor & Partner Materials</h3>
