...
export default function PrivacyPolicy() {
 ...
 <meta
 name="description"
 content="How SynexiAI collects, uses, and protects your data."
 />
 ...
 >
 <p>
 This Privacy Policy explains how <strong>SynexiAI</strong>{" "}
 (“we”, “us”, “our”) collects, uses, and safeguards personal
 information when you use <code>synexiai.online</code> and our
 services (collectively, the “Services”).
 </p>

 <details
 className="group border border-[var(--border-color)] rounded-xl p-4 bg-[var(--card-bg)]"
 open
 >
 ...
 <li>
 <strong>Contact data</strong> (e.g., name, email) when you
 submit a form or contact us.
 </li>
 <li>
 <strong>Usage data</strong> (pages viewed, device,
 approximate location).
 </li>
 <li>
 <strong>Cookies</strong> and similar technologies. See our{" "}
 <Link to="/cookie-policy" className="link-accent">
 Cookie Policy
 </Link>
 .
 </li>
 <li>
 <strong>AI chat inputs</strong> you submit in our on-site
 chat widget to respond and improve the experience.
 </li>
 </ul>
 </div>
 </details>
 ...
 <ul className="space-y-1.5">
 <li>
 Provide, maintain, and improve the website and chat
 experience.
 </li>
 ...
 with service providers (e.g., analytics, hosting) under
 ...
 protect your data. No system is 100% secure, but we
 ...
 correct, delete, or restrict processing of your data, and
 opt-out of certain uses. Contact us to exercise these
 rights.
 </p>
 </div>
 </details>
 ...
 <div className="mt-3">
 <p>
 We may update this Policy. We’ll post updates here and
 revise the “Last updated” date. Please review periodically.
 </p>
 </div>
 </details>
