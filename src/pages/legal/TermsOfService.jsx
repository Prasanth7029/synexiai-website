  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Terms and conditions for using SynexiAI services and website." />
          ...
          <div className="bg-[var(--card-bg)] text-[var(--card-text)] rounded-2xl shadow-xl p-5 sm:p-7 lg:p-8 backdrop-blur-sm border border-[var(--border-color)]">
            ...
            ">
              <p>
                ...
                <strong> SynexiAI</strong> services and <code>synexiai.online</code> (the “Services”).
              ...
              <details className="group border border-[var(--border-color)] rounded-xl p-4 bg-[var(--card-bg)]">
                ...
                <div className="mt-3">
                  <ul className="space-y-1.5">
                    <li className="flex items-start"><span className="badge-check" /><span>Do not misuse, disrupt, or harm the Services or others’ use of them.</span></li>
                    <li className="flex items-start"><span className="badge-check" /><span>Do not attempt to reverse engineer or circumvent security.</span></li>
                    <li className="flex items-start"><span className="badge-check" /><span>Comply with applicable laws and third-party rights.</span></li>
                  </ul>
                </div>
              </details>
              ...
              <details className="group border border-[var(--border-color)] rounded-xl p-4 bg-[var(--card-bg)] mt-3" open>
                ...
                <div className="mt-3">
                  <p>
                    Content generated by or via our AI chat is provided “as is” for informational purposes and may be inaccurate.
                    You are responsible for evaluating outputs and using them at your own discretion.
                  </p>
                </div>
              </details>
              ...
              <details className="group border border-[var(--border-color)] rounded-xl p-4 bg-[var(--card-bg)] mt-3">
                ...
                <div className="mt-3">
                  <p>
                    The Services, including logos, trademarks, code, and content, are owned by SynexiAI or licensors.
                    You may not copy, modify, or distribute proprietary content without permission.
                  </p>
                </div>
              </details>
              ...
              <details className="group border border-[var(--border-color)] rounded-xl p-4 bg-[var(--card-bg)] mt-3">
                ...
                <div className="mt-3">
                  <p>
                    To the fullest extent permitted by law, SynexiAI shall not be liable for indirect, incidental, special,
              ...
              <details className="group border border-[var(--border-color)] rounded-xl p-4 bg-[var(--card-bg)] mt-3">
                ...
                <div className="mt-3">
                  <p>
                    We may suspend or terminate access if you violate these Terms or for security or operational reasons.
                  </p>
                </div>
              </details>
              ...
              <details className="group border border-[var(--border-color)] rounded-xl p-4 bg-[var(--card-bg)] mt-3">
                ...
                <div className="mt-3">
                  <p>
                    These Terms are governed by the laws of the jurisdiction where SynexiAI is established, without regard to conflict-of-law principles.
                  </p>
                </div>
              </details>
              ...
              <details className="group border border-[var(--border-color)] rounded-xl p-4 bg-[var(--card-bg)] mt-3">
                ...
                <div className="mt-3">
                  <p>
                    Email: <a href="mailto:legal@synexiai.online" className="link-accent">legal@synexiai.online</a>
                  </p>
                  <p className="text-xs opacity-70">This page is provided for informational purposes and is not legal advice.</p>
                </div>
              </details>
            </div>
          </div>
